...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_KEYBOARD] = WizardPage(_("Layout teclado"), "keyboard.png")
        self.wizard_pages[self.PAGE_USER] = WizardPage(_("Informacoes do usuario"), "user.png")
        ...
        # partitions
        self.wTree.get_widget("button_edit").set_label(_("Editar particoes"))
        self.wTree.get_widget("button_refresh").set_label(_("Atualizar"))
        self.wTree.get_widget("button_custommount").set_label(_("Modo avancado"))
